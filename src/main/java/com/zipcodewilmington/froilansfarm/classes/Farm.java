...
public class Farm {
    ...
    public void addChickenCoop(List<ChickenCoop> chickenCoops) {
        this.chickenCoops.addAll(chickenCoops);
    }
    ...
    public List<ChickenCoop> removeChickenCoop(List<ChickenCoop> chickenCoopsToBeRemoved) {
        List<ChickenCoop> removedChickenCoops = new LinkedList<ChickenCoop>(this.chickenCoops);
    ...
    public void addStable(List<Stable> stables) {
        this.stables.addAll(stables);
    }
    ...
    public List<Stable> removeStable(List<Stable> stablesToBeRemoved) {
        List<Stable> removedStables = new LinkedList<Stable>(this.stables);
    ...
    public List<Vehicle> removeVehicle(List<Vehicle> vehiclesToBeRemoved) {
        List<Vehicle> removedVehicles = new LinkedList<Vehicle>(this.vehicles);
